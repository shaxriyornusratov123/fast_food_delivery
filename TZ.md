...
R4: user should be able see all filials
R5: user should be albe to choose your address in map
R6: user should be able to choose language
R7: user should be able to choose region
R8: user should be able to see history of orders, transactions
R9: user should be able to liked in products
R10: user should be albe to see discount
